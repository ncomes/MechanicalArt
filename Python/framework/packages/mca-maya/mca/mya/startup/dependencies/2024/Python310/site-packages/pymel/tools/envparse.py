            ...
            if tok.type == 'VAR':
                ...
                if var is not None:
                    ...
                    if var in symbols:
                        ...
                        # For these variables ONLY, mya will append the value in mya.env to an exisiting environment variable
                        # (Default is for already defined value to override value in mya.env)
