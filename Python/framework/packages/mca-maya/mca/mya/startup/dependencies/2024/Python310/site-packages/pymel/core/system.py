...
In particular, the system module contains the functionality of mya.cmds.file.
...
class Namespace(str):
    ...
    def listNamespaces(self, recursive=False, internal=False):
        ...
        internal : bool
            ...
            mya namespaces (ie, :UI, :shared); set to True to show these
    ...
    def listNodes(self, recursive=False, internal=False):
        ...
        internal : bool
            ...
            created mya namespaces (ie, :UI, :shared); set to True to show
...
class FileReference(object):
    ...
    the path will automatically be suffixed with the copy number before being passed to mya commands, thus ensuring
    the proper results in mya as well.
    ...
    def __init__(self, pathOrRefNode=None, namespace=None, refnode=None):
        ...
        # for speed reasons, we use raw mya.cmds, instead of pmcmds, for some
        # calls here...
...
#        return cmds.file( self.withCopyNumber(), q=1, deferReference=1 )
    ...
    def removeReferenceEdits(self, editCommand=None, force=False, **kwargs):
        ...
        like mya.cmds.file/mya.cmds.referenceEdit, no error will be raised
...
def _translateEditFlags(kwargs, addKwargs=True):
    ...
    True, False, or None), returns the corresponding mya.cmds values to use
    """
...
def renameFile(newname, *args, **kwargs):
    ...
    # mya retains some sense of whether a file is .ma or .mb, independent of
...
def saveFile(**kwargs):
    ...
    # mya sometimes gets in a messed up state, where some methods don't think
