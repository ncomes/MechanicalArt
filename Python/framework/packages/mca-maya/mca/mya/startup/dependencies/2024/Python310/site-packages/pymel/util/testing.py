...
def doctestFriendly(func):
    """
    Decorator which prepares mya to run doctests.
    """
    def prepForDoctest(*args, **kwargs):
        ...
        if (sys.displayhook != sys.__displayhook__
            ...
            # Note - for python 2.4 (ie, mya 8.5) compatability, can't use
...
def doctestobj(*args, **kwargs):
    """
    Wrapper for doctest.run_docstring_examples that works in mya gui.
    """
...
def doctestmod(*args, **kwargs):
    """
    Wrapper for doctest.testmod that works in mya gui.
    """
...
# class MayaTestRunner(TextTestRunner):
#    '''
#    Test runner for unittests that require mya.
#    '''
#
