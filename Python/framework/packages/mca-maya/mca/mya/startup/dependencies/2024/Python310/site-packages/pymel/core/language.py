...
class Mel(object):
    ...
    executed via ``mya.mel.eval``.  An instance of this class is created for
    ...
    ``mya.mel.eval`` are more readily apparent when we want to pass a python
    ...
    Another advantage of this class over mya.mel.eval is its handling of mel
    ...
    .. note::
        ...
        To remain backward compatible with mya.cmds, `MelError`, the base
    ...
    def eval(cls, cmd):
        ...
        Behaves like `mya.mel.eval`, with several improvements:
