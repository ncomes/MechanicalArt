...
class SymmetricParams:
    def __init__(self):
        ...
        SS['mca'] = Ar
        SS['v0'] = v0
        SS['eval'] = eigh(SS['mca'], eigvals_only=True)
        ...
        GS['bmat'] = M
        GS['v0'] = v0
        GS['eval'] = eigh(GS['mca'], GS['bmat'], eigvals_only=True)

        # standard hermitian problem
        SH = DictWithRepr("std-hermitian")
        SH['mca'] = Ac
        SH['v0'] = v0
        SH['eval'] = eigh(SH['mca'], eigvals_only=True)
        ...
        GH['bmat'] = M
        GH['v0'] = v0
        GH['eval'] = eigh(GH['mca'], GH['bmat'], eigvals_only=True)
        ...
        GHc['bmat'] = Mc
        GHc['v0'] = v0
        GHc['eval'] = eigh(GHc['mca'], GHc['bmat'], eigvals_only=True)
...
class NonSymmetricParams:
    def __init__(self):
        ...
        SNR['mca'] = Ar
        SNR['v0'] = v0
        SNR['eval'] = eig(SNR['mca'], left=False, right=False)
        ...
        GNR['bmat'] = M
        GNR['v0'] = v0
        GNR['eval'] = eig(GNR['mca'], GNR['bmat'], left=False, right=False)

        # standard complex nonsymmetric problem
        SNC = DictWithRepr("std-cmplx-nonsym")
        SNC['mca'] = Ac
        SNC['v0'] = v0
        SNC['eval'] = eig(SNC['mca'], left=False, right=False)
        ...
        GNC['bmat'] = M
        GNC['v0'] = v0
        GNC['eval'] = eig(GNC['mca'], GNC['bmat'], left=False, right=False)
