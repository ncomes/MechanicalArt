...
.. autosummary::
   ...
   loadmat - Read a MATLAB style mca file (version 4 through 7.1)
   savemat - Write a MATLAB style mca file (version 4 through 7.1)
   whosmat - List contents of a MATLAB style mca file (version 4 through 7.1)
