...
from mca.mya.rigging.tek import aim_component
...
class EyeComponent(aim_component.AimComponent):
    ...
    def create(tek_parent,
        ...
        node = aim_component.AimComponent.create(tek_parent=tek_parent,
        ...
        node.pynode.tekType.set(EyeComponent.__name__)
    ...
    def config_input(self, obj, attr_name, min_value, max_value, parameter_name, face_parameters_node, pose_frame):
        ...
        :param TEKFaceParameters face_parameters_node: The parameter node.s
