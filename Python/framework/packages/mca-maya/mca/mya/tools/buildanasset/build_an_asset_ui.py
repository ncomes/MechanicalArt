...
class BuildAnAssetUi(mayawindows.MCAMayaWindow):
    def __init__(self):
        ...
        self.header_box = qtwidgets.QHBoxLayout(self.header_frame)

        self.header_label = qtwidgets.QLabel('Build An Asset')
        ...
        self.header_spacer = qtwidgets.QSpacerItem(40, 20, qtwidgets.QSizePolicy.Expanding, qtwidgets.QSizePolicy.Minimum)
        ...
        self.tab_main_layout = qtwidgets.QHBoxLayout(self.tab_frame)

        self.splitter = qtwidgets.QSplitter(self.tab_frame)
        self.splitter.setMinimumSize(800, 600)
        self.splitter.setStretchFactor(1,2)
        self.splitter.setOrientation(qtcore.Qt.Horizontal)
        self.tab_main_layout.addWidget(self.splitter)

        self.tab_btn_frame = qtwidgets.QFrame()
        self.tab_btn_frame.setMaximumSize(225, 600)
        self.tab_btn_frame.setSizePolicy(qtwidgets.QSizePolicy.Preferred, qtwidgets.QSizePolicy.Minimum)
        self.tab_btn_frame.setContentsMargins(0, 0, 0, 0)
        self.tab_btn_frame.setFrameStyle(qtwidgets.QFrame.Box | qtwidgets.QFrame.Sunken)
        self.tab_btn_layout = qtwidgets.QVBoxLayout()
        self.tab_btn_frame.setLayout(self.tab_btn_layout)

        self.splitter_spacer = qtwidgets.QSpacerItem(40, 20, qtwidgets.QSizePolicy.Expanding, qtwidgets.QSizePolicy.Minimum)
        self.tab_main_layout.addItem(self.splitter_spacer)

        self.ui_body_frame = qtwidgets.QFrame(self)
        self.ui_body_frame.setContentsMargins(3, 3, 3, 3)
        self.ui_body_frame.setFrameStyle(qtwidgets.QFrame.Box | qtwidgets.QFrame.Sunken)
        ...
        self.btn_layout_spacer = qtwidgets.QSpacerItem(40, 20, qtwidgets.QSizePolicy.Minimum, qtwidgets.QSizePolicy.Expanding)
        self.tab_btn_layout.addItem(self.btn_layout_spacer)

        # add Helios
        self.helios_frame = qtwidgets.QFrame(self.ui_body_frame)
        self.helios_frame.setMinimumSize(400, 500)
        self.helios_layout = qtwidgets.QVBoxLayout(self.helios_frame)
        ...
        self.skel_frame = qtwidgets.QFrame(self.ui_body_frame)
        self.skel_frame.setMinimumSize(400, 500)
        self.skel_bldr_layout = qtwidgets.QVBoxLayout(self.skel_frame)
