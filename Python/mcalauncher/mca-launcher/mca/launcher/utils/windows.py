...
import os
import logging
from PySide6.QtWidgets import QApplication, QDockWidget, QMainWindow, QWidget, QVBoxLayout
...
def get_all_open_windows(skip_dialog=True):
    """
    Returns all open windows in PySide6

    :return: Returns all open windows in PySide6
    :rtype: list[PySide6]
    """
...
def get_all_mca_windows():
    """
    Returns all open MCA windows in PySide6

    :return: Returns all open MCA windows in PySide6
    :rtype: list[PySide6]
    """
