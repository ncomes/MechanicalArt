...
class AimComponent(keyable_component.KeyableComponent):
    ...
    def create(tek_parent,
        ...
        # Connect to nodes
        node.connect_node(aim_flag, 'flag', 'tekParent')
        node.connect_node(bind_joint, 'bindJoints', 'tekParent')
        node.connect_node(rotate_loc, 'rotateObject', 'tekParent')
