...
from mca.mya.rigging.frag import frag_base, spline_ik_component
...
class LeaperTongueComponent(spline_ik_component.SplineIKComponent):
    ...
    def create(frag_parent,
        ...
        node = spline_ik_component.SplineIKComponent.create(frag_parent,
                                                            start_joint,
                                                            end_joint,
                                                            end_helper_joint,
                                                            mid_helper_joint,
        ...
        node.setAttr(frag_base.FRAG_TYPE_ATTR, LeaperTongueComponent.__name__)
        ...
        node.connect_nodes(add_nodes, 'addNodes', 'fragParent')
