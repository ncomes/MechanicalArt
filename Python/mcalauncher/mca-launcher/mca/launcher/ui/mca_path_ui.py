...
from PySide6.QtWidgets import QMainWindow, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QWidget
...
class DCCPathLauncher(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.req_label_font.setWeight(QFont.Weight(75))
        ...
        self.project_valid_font.setWeight(QFont.Weight(75))
