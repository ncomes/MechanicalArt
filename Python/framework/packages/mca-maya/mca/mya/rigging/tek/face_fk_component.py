...
class FaceFKComponent(fk_component.FKComponent):
	...
	def create(tek_parent,
		...
		node.tekType.set(FaceFKComponent.__name__)
	...
	def config_input(self, obj, attr_name, min_value, max_value, parameter_name, face_parameters_node, pose_frame):
		...
		:param TEKFaceParameters face_parameters_node: The parameter node.
	...
	def flag_follow_mesh(self, mesh):
		...
		dnt_grp = self.get_tek_parent().do_not_touch
		...
		self.connect_nodes([rivet_loc, uv_pin], 'flagFollowNodes', 'tekParent')
