...
try:
    ...
    print("mya.cmds module cannot be found. be sure to run this script "
          "through mya and not from the command line. Continuing, but without "
          "command support")
...
def format_command(command, args, t):
    ...
    try:
        ...
        # eval command is the same as using mya.mel.eval.
...
#        # So, just use the mya.cmds.python command...
#        elif command == 'python':
...
class MelParser(object):
    ...
    def build(self, rootModule=None, pymelNamespace='', verbosity=0,
        ...
        self.lexer.type_map = {}
        self.lexer.global_var_include_regex = 'gv?[A-Z_].*'     # mya global vars usually begin with 'gv_' or a 'g' followed by a capital letter
